  ...
  Scenario: fill out registration form
    ...
    Scenario Outline: fill out registration  forms
      ...
      Examples:
        ...
        |Santiago|Puerta|puertassantiagos@gmail.com|October  | 21    |1995   |Spanish     |Bello  | 1350        |Alcatel        |One Touch Idol|Android 6      |Camila951021.*|Camila951021.*     |The last step|
